            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-pole-sse<?php echo $language['language_id']; ?>"><?php echo $entry_pole_sse; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][pole_sse]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['pole_sse'] : ''; ?>" placeholder="<?php echo $entry_pole_sse; ?>" id="input-pole-sse<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
