...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
      ...
      $this->request->post['config_pole_sse'] = $this->request->post['config_langdata'][$front_language_id]['pole_sse'];
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		$data['entry_pole_sse'] = $this->language->get('entry_pole_sse');
		...
		if (isset($this->request->post['config_pole_sse'])) {
			$data['config_pole_sse'] = $this->request->post['config_pole_sse'];
		} else {
			$data['config_pole_sse'] = $this->config->get('config_pole_sse');
		}
